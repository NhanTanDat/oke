...
class APIManager{
    ...
    public func requestAPI(endPoint: String, params:Parameters? = nil, methodHTTP: HTTPMethod = .post, signatureHeader:Bool, optionalHeaders:HTTPHeaders?, showProgressLoading:Bool = true, vc:UIViewController?, handler: @escaping (JSON?, HiFPTStatusResult?)->()){
